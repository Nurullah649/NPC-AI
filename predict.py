...
def main():
    ...
    for img in frames:
        ...
        positions.append(tracker.get_positions())
        ...
        for translation in tracker.get_positions():
            x, y = np.array(translation)
        ...
        json_file_path = "output.json"  # Dilediğiniz dosya adını ve yolunu belirleyebilirsiniz
