...
def tasima(kaynak_dizin, hedef_dizin):
    ...
    for dosya in dosyalar:
        ...
        if os.path.isfile(kaynak) and dosya.endswith(('.png', '.jpg', '.jpeg', '.gif')):#''.png', '.jpg', '.jpeg', '.gif'
            ...
            if os.path.exists(hedef):
                ...
                yeni_isim = dosya.split('.')[0] + '_yeni.' + dosya.split('.')[1]
...
kaynak_dizin = "/home/npc-ai/Masaüstü/2022_dataset/train/images"
hedef_dizin = "/home/npc-ai/Masaüstü/DENEME_DATA/images/train"
