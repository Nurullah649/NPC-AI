...
def augment_image(image, noise_type="gaussian", noise_std=25, blur_ksize=15, hue_shift=50, brightness=1.5,
                  contrast=1.5):
    # Parazit ekleme
...
# Görüntüyü yükle
image = cv2.imread('../../Predict/images/2021/TUYZ_2021_Ornek_Veri_Seti/frame_000000.jpg')
image = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)

# Veri artırımı işlemi uygulama
augmented_image = augment_image(image, noise_type="gaussian", noise_std=50, blur_ksize=15, hue_shift=60, brightness=1.7,
                                contrast=1.5)
