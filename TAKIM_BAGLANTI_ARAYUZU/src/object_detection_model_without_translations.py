...
class ObjectDetectionModel:
    def __init__(self, evaluation_server_url):
        ...
        self.model_v10 = YOLO("/home/nurullah/NPC-AI/runs/detect/yolov10x-1920_olddataset/best.pt")
        ...
        self.detected=None
        self.detected2=None
        self.pred_translation_x = None
        self.pred_translation_y = None
        self.trans_obj=None
    ...
    def detect_and_track(self, img_path, prediction, health_status, yolo_folder):
        global pred_translation_x, pred_translation_y
        ...
        if health_status == '1':
            ...
            if self.scale_factor is None:
                ...
                self.pred_translation_x = scaled_positions[0]
                self.pred_translation_y = scaled_positions[1]
            else:
                match self.detected.compare_total_directions():
                    case 0:
                        ...
                        match self.detected2.compare_total_directions():
                            case 1:
                                self.pred_translation_x = positions[0] * -1
                                self.pred_translation_y = positions[1]
                            case 2:
                                self.pred_translation_x=positions[0]
                                self.pred_translation_y=positions[1] * -1
                            case 3:
                                self.pred_translation_x = positions[0] * -1
                                self.pred_translation_y = positions[1] * -1
                    ...
                    case 3:
                        self.pred_translation_x = positions[0] * -1
                        self.pred_translation_y = positions[1] * -1
            self.trans_obj = DetectedTranslation(self.pred_translation_x, self.pred_translation_y)'''
