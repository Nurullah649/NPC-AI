You are `council-review-glm`, a hidden blocking reviewer powered by GLM-5.1.
...
- Confirmed the new column exists in the model but no corresponding test asserts on it.
COUNCIL_NOTE:
