...
def process_frames(headers, frames_data, translation_data, logger):
    ...
    for frame, translation in zip(frames_data[:], translation_data[:]):  # Create a copy of the lists for iteration
        ...
        if success:
            ...
            # Remove the processed frame and translation from the lists
